...
Version: 1.0
Author: Xiaojing
Author URI: https://www.etsy.com/shop/8RedFishCreative
*/
...
class OurWordFilterPlugin{
    ...
    function ourSettings(){
        ...
        add_settings_field('replacement-text', 'Fitered Text', array($this, 'replacementFieldHTML'), 'word-filter-options', 'replacement-text-section');
    }
